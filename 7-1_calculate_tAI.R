...
# TAIs
TAIs = read.csv("/home/xhernandez/Documents/tAI_genomic/tAI_CUgenomic.csv", row.names = 1)
...
# Calculate arcsinh weighted tAI
weightedTAI = as.matrix(t(asinh(matched_genexp)))%*%as.matrix(TAIs)
weightedTAI = weightedTAI/colSums(matched_genexp)
write.csv(weightedTAI,"results/arcsinhweighted_tAI.csv")