...
cu_TAIs = read.csv("results/TStrna_cor_tAI_CUcentric.csv",row.names = 1)
...
trna_TAIs = read.csv("results/TStrna_cor_tAI_trnacentric.csv",row.names = 1)
...
pdf("plots/TStrna_tAI_cor_paired.pdf",height=8,width = 12)
...
pdf("plots/TStrna_tAI_cor_unpaired.pdf",height=5,width = 15)
