...
for (t in tissues_unique){
  # TAIs
  idxtissue = (tissues==t)
  TAIs = read.csv(sprintf("/home/xhernandez/Downloads/tAI_genomic/%sbottom_tAI_CUgenomic.csv",t), row.names = 1)
  # Rename samples based on clustering
...
write.csv(corTAI_trna,"results/bottomtrna_cor_tAI_trnacentric.csv")
write.csv(corTAI_CU,"results/bottomtrna_cor_tAI_CUcentric.csv")
