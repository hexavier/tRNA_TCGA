...
for (s in tissues_unique){
  # TAIs
  idxtissue = (tissues==s)
  TAIs = read.csv(sprintf("/home/xhernandez/Downloads/tAI_genomic/%sbottom_tAI_CUgenomic.csv",s), row.names = 1)
  # Rename samples based on clustering
...
write.csv(weightedTAI_trna,"results/bottomtrna_weighted_tAI_trnacentric.csv")
write.csv(weightedTAI_CU,"results/bottomtrna_weighted_tAI_CUcentric.csv")
